...
A1–A6, K-fit Weizsäcker–Williams), trained on 224 pipeline runs — one full
...
- held-out accuracy (v3 regional emulator, 224 training runs): median
  |rel. error| ≈ 0.12%, 95th pct 2.5%; the display applies a light smoothing
  along kT (the pickled emulator is raw — see TMD_emulator.pdf, Sec. 6).
